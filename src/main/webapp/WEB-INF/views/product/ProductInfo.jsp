                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="text-align: center">
                        ...
                        <div class="row btn-light">
                            ...
                            <div class="col-2"><%=CmmUtil.nvl(rDTO.getProduct_name())%>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2" align="center">주소</div>
                            <div class="col-2"><%=CmmUtil.nvl(rDTO.getAddr())%>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6"><img class="img-fluid" src="<%=CmmUtil.nvl(rDTO.getFileurl())%>" /></div>
