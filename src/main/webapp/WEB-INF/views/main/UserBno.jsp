                    ...
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                ...
                                <h5>사업자 번호</h5>
                                <div class="form-control mb-3">
                                    <div class="text-black" id="bno">
                                        <label for="bno"><%=CmmUtil.nvl(rDTO.getB_no())%></label>
                                    </div>
                                </div>
                                <h5>납세자 상태</h5>
                                <div class="form-control mb-3">
                                    <div class="text-black" id="bstt">
                                        <label for="bstt"><%=CmmUtil.nvl(rDTO.getB_stt())%></label>
                                    </div>
                                </div>
                                <h5>과세유형</h5>
                                <div class="form-control mb-3">
                                    <div class="text-black" id="taxtype">
                                        <label for="taxtype"><%=CmmUtil.nvl(rDTO.getTax_type())%></label>
                                    </div>
                                </div>
                            </div>
                        </div>
